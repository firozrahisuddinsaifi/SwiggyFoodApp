...
{/* 
            <header className="bg-[#ff5200] ">     
                   ...
                   <img className="w-40 h-12 text-lg md:text-2xl" src="https://res.cloudinary.com/dutdah0l9/image/upload/v1720058694/Swiggy_logo_bml6he.png"></img>
                   <div className="text-white text-base font-bold  gap-15 items-center flex grid-gap-8">
...
{/* <div class="container mx-auto p-4">
    ...
    <nav>
            <ul class="flex space-x-4">
                <li><a target="_blank" href="https://www.swiggy.com/corporate/">Swiggy Corporate</a></li>
                <li><a href="https://partner.swiggy.com/login#/swiggy">Partner with us</a></li>
                <li><a className="border rounded-3xl border-white py-3 px-4 " href="#">Get the App</a></li>
                <li><a  className="border rounded-3xl border-black bg-black py-3 px-6" href="#">Sign in</a></li>
            </ul>
        </nav>
    </header>
    ...
    <main class="my-8">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <div class="bg-white p-6 rounded-lg shadow-lg">
                <h2 class="text-xl mb-4">Card 1</h2>
                <p>This is a card. On small screens, all cards will stack vertically.</p>
            </div>
            <div class="bg-white p-6 rounded-lg shadow-lg">
                <h2 class="text-xl mb-4">Card 2</h2>
                <p>This is another card. The layout changes based on the screen width.</p>
            </div>
            <div class="bg-white p-6 rounded-lg shadow-lg">
                <h2 class="text-xl mb-4">Card 3</h2>
                <p>This card appears on the same row when the screen is medium size or larger.</p>
            </div>
        </div>
    </main>
...
<header className="bg-[#ff5200]">     
  ...
  <div className="max-w-[90%] md:max-w-[80%] container mx-auto flex  justify-between gap-5">
    <a href="https://www.swiggy.com/restaurants" className="w-full md:w-[48%]">
